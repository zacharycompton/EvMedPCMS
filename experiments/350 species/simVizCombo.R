...
resultsOU <- read.csv("./pglsLambdaSimResultsOU350123.csv")
resultsBrown <- read.csv("./pglsLambdaSimResultsBrown350123.csv")
resultsWhite <- read.csv("pglsLambdaSimResultsWhite350123.csv")
resultsPagel <- read.csv("./pglsLambdaSimResultsPagel350123.csv")
...
ggsave(file = "error50Species.pdf", width = 13, height = 10)